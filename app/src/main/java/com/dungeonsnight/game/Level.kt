...
private fun dragon(c: Int, floor: Int) = EnemySpawn("dragon", c * TILE - 20f, floor * TILE - 88f)
...
private fun level1(): LevelData {
    ...
    return LevelData(
        ...
        129 * TILE + 2f, 12 * TILE - 26f,
        listOf(slime(34, 13), slime(76, 11), slime(108, 13), bat(56, 4), bat(84, 3), bat(101, 3, 8f), dragon(120, 13)),
        listOf(coin(12, 13), coin(52, 9), coin(86, 5), heal(114, 13), mana(127, 12)),
...
private fun level2(): LevelData {
    ...
    ledge(t, cols, rows, 124, 11, 132)
    ledge(t, cols, rows, 130, 8, 136)
    ...
    return LevelData(
        ...
        145 * TILE + 2f, 11 * TILE - 26f,
        listOf(
            slime(18, 16), slime(30, 22), slime(52, 22), slime(74, 20), slime(108, 23),
            bat(40, 5), bat(56, 4), bat(88, 6), bat(126, 6), dragon(138, 12),
        ),
        listOf(coin(20, 16), coin(55, 22), coin(100, 23), heal(133, 12), mana(144, 11)),
...
private fun level3(): LevelData {
    ...
    return LevelData(
        ...
        157 * TILE + 2f, 17 * TILE - 26f,
        listOf(
            slime(10, 24), slime(66, 23), slime(88, 20), slime(110, 22), slime(140, 18),
            bat(20, 5), bat(40, 3), bat(50, 2), bat(96, 8), bat(122, 5), bat(134, 6), dragon(148, 18),
        ),
        listOf(coin(10, 24), coin(66, 23), coin(120, 8), heal(145, 18), mana(156, 17)),
        torches(intArrayOf(8, 24, 48), 4) + torches(intArrayOf(66, 86, 110), 12) + torches(intArrayOf(130, 150), 10),
    )
}
